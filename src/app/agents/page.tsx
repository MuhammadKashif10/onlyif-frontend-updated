  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {agents.length === 0 ? (
            <div className="relative min-h-[300px] w-full overflow-hidden rounded-2xl shadow-lg sm:min-h-[340px]">
              <Image
                src="/images/04.jpg"
                alt=""
                fill
              ...
              <div className="relative z-10 flex min-h-[300px] flex-col items-center justify-center px-6 py-14 text-center sm:min-h-[340px] sm:py-16">
                <h2 className="text-2xl font-bold tracking-tight text-white sm:text-3xl">
                  Want to become an agent?
                </h2>
                <p className="mt-3 max-w-xl text-base text-white/90 sm:text-lg">
                  Get in touch and we&apos;ll walk you through joining the OnlyIf agent network.
                </p>
                <Link
                  href="/contact"
                  className="mt-8 inline-flex items-center justify-center rounded-full bg-[#3AB861] px-8 py-3 text-base font-semibold text-white shadow-md transition hover:bg-[#2d9e4f] focus:outline-none focus:ring-2 focus:ring-[#3AB861] focus:ring-offset-2 focus:ring-offset-transparent"
                >
                  Contact Us
                </Link>
              </div>
            ...
            <>
              <h2 className="mb-8 text-center text-3xl font-bold text-gray-900">OnlyIf Agents</h2>
