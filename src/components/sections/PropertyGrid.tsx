...
interface PropertyGridProps {
  ...
  /** Shown when there are no listings and the user has not applied search/filters */
...
function hasActiveFilters(filters: FilterOptions): boolean {
  return Object.entries(filters).some(([, v]) => v !== undefined && v !== null && v !== '');
}
...
export default function PropertyGrid({
  ...
  return (
    <div className={className}>
      ...
      {/* Results Summary */}
      {!featuredOnly && totalProperties > 0 && (
        <div className="mb-6">
        ...
        <NoResults
          ...
          suggestion={
            searchQuery.trim() || hasActiveFilters(filters)
              ...
              : (emptyStateSuggestion ?? 'Check back later for new listings.')
          }
          ctaHref={
            !searchQuery.trim() && !hasActiveFilters(filters) && emptyStateCtaHref && emptyStateCtaLabel
              ? emptyStateCtaHref
              : undefined
          }
          ctaLabel={
