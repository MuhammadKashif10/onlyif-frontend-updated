...
export const NoResults: React.FC<{
  ...
  <div className={`text-center py-12 ${className}`}>
    ...
    <p className="text-gray-600 max-w-md mx-auto">{suggestion}</p>
    {ctaHref && ctaLabel ? (
      <div className="mt-6">
        <Link
          href={ctaHref}
          className="inline-flex items-center justify-center rounded-md bg-emerald-600 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition-colors"
        >
          {ctaLabel}
        </Link>
      </div>
