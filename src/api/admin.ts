...
export const adminApi = {
  ...
  updateProperty: (propertyId: string, data: any) =>
    apiClient.patch(`/admin/properties/${propertyId}`, data),
  assignPropertyToAgent: (propertyId: string, data: { agentId: string }) =>
    apiClient.patch(`/admin/properties/${propertyId}/assign-agent`, data),
  ...
  deleteAgent: (agentId: string) => apiClient.delete(`/admin/agents/${agentId}`),
